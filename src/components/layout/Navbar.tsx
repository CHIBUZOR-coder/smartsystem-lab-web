      ...
      <header
        ...
        style={
          isDark
            ? {
                background:
                  'linear-gradient(135deg, #061414 0%, #0A2828 50%, #061414 100%)'
              }
      ...
      >
        ...
        {isDark && (
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse 60% 120% at 50% -20%, rgba(0,200,150,0.18) 0%, transparent 70%)'
            }}
            aria-hidden='true'
          />
        )}
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-6'>
          <Link
            ...
            to='/'
            aria-label='AZ SmartSystem Lab home'
            className='shrink-0 block w-10 h-10 rounded-lg'
          ></Link>
          {/* Desktop nav */}
          <nav
                          ...
                          style={
                            isDark
                              ? {
                                  ...
                                  boxShadow:
                                    '0 0 0 1px rgba(0,200,150,0.25), 0 0 12px rgba(0,200,150,0.10)'
                                }
                              : {
